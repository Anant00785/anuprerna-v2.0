...
**apps/api exposes 929 routes** across 147 controllers (DELETE 61, GET 562, PATCH 108, POST 197, PUT 1).
...
| GET | `/get/artisan/catalog-list` | `apps/api/src/commerce/domain/artisan-migrated.controller.ts` |
...
| GET | `/get/customer/profile` | `apps/api/src/commerce/domain/customer.controller.ts` |
...
| GET | `/get/fabric-preview-list` | `apps/api/src/commerce/domain/fabric-product-migrated.controller.ts` |
...
| GET | `/get/segment-list` | `apps/api/src/commerce/domain/segment-migrated.controller.ts` |
...
| GET | `/get/skills` | `apps/api/src/commerce/domain/misc-migrated.controller.ts` |
...
| GET | `/get/table-explorer/data/blog-content` | `apps/api/src/commerce/domain/content-ai-migrated.controller.ts` |
...
| GET | `/get/table-explorer/data/blog-content-section` | `apps/api/src/commerce/domain/content-ai-migrated.controller.ts` |
...
| GET | `/get/table-explorer/data/blog-content-type` | `apps/api/src/commerce/domain/content-ai-migrated.controller.ts` |
...
| GET | `/get/table-explorer/data/story-content` | `apps/api/src/commerce/domain/content-ai-migrated.controller.ts` |
...
| GET | `/get/table-explorer/data/story-content-section` | `apps/api/src/commerce/domain/content-ai-migrated.controller.ts` |
...
| PATCH | `/update/customer/profile` | `apps/api/src/commerce/domain/customer.controller.ts` |
...
| POST | `/update/customer/profile` | `apps/api/src/commerce/domain/customer.controller.ts` |
| POST | `/update/customer/profile` | `apps/api/src/commerce/profile/controller/tenant-profile.controller.ts` |
