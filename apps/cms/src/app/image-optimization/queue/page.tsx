  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <PageHeading heading="Image Optimization Queue" />
      </div>

      <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
        <p className="text-sm text-slate-600">
          0 pending images in queue. Automatic batch processing converts uploaded high-resolution JPEGs to WebP format.
        </p>
      </div>
    </div>
  );
