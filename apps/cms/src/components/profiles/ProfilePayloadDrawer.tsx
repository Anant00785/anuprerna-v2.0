...
interface ProfilePayloadDrawerProps {
...
/**
 * Shared "Preview — you can edit; saving goes live at launch" payload drawer for the profile CRUD
 * forms. Shows the assembled Loom write-payload as formatted JSON so the shape
 * can be verified before the write endpoints are wired up. Mirrors
 * CatalogPayloadDrawer. Nothing is ever sent to Loom.
 */
export function ProfilePayloadDrawer({
  payload,
  onClose,
  entityName = "profile",
}: ProfilePayloadDrawerProps) {
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative flex h-full w-full max-w-xl flex-col bg-white shadow-2xl">
        ...
        >
          ...
          <button onClick={onClose} className="text-2xl leading-none" style={{ color: "#847D77" }}>
            ×
          </button>
        </div>
