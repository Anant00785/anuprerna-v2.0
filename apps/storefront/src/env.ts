...
const schema = z.object({
  ...
  NEXT_PUBLIC_API_URL: z.string().url().default("https://anuprerna-api.onrender.com"),
...
export const env = schema.parse({
  ...
  NEXT_PUBLIC_API_URL: cleanUrl(process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_NEST_API_URL, "https://anuprerna-api.onrender.com"),
