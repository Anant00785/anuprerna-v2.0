/**
 * src/commerce/pattern/controller/pattern.controller.gates.spec.ts
 *
 * Authorization regression tests for PatternController — generated as part of the
